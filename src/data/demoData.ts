...
export function getSystemGroupsForRepo(_repoId?: string): { id: SystemGroup; label: string; color: string }[] {
...
export function getNodesForLevel(level: ZoomLevel, _repoId?: string): GraphNode[] {
...
export function getEdgesForLevel(level: ZoomLevel, _repoId?: string): GraphEdge[] {
